...
import com.mojodigitech.filehunt.Adapter.MultiSelectAdapter_Video;
...
public class VideoActivityRe extends AppCompatActivity implements AlertDialogHelper.AlertDialogListener, MultiSelectAdapter_Video.VdoListener,  encryptAsyncTask.EncryptListener {
