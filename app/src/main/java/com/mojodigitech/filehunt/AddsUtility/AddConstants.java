...
//    public static final String VENDOR_ID="SAMSUNGFH002";
    ...
    public static final String API_URL="https://khulasa-news.com/app_custom_ads/getAdDetailsByAppName.php";

    public static final String CUSTOM_ADD_API_URL="https://khulasa-news.com/app_custom_ads/showCampaignsByCountry.php";
    ...
    public static   String hidden_file_path="hidden_file_path";

    public static ArrayList<String> hidden_file_pathList= null;
  ...
  // this values will  be compared with  the server key addProvId and on the basis od that adds will be displayed;
    ...
    public static JSONObject prepareCustomAddJsonRequest(Context mContext, String valueVendorId)
    {
        ...
        try {
            ...
            object.put(key_countryCode,countryCodeValue.toUpperCase());
            //object.put(key_countryCode,"NLD" );
    ...
    public static JSONObject prepareAddJsonRequest(Context mContext, String valueVendorId, String versionName,int versionCode)
    {
        ...
        try {
            ...
            object.put(key_appName, mContext.getString(com.mojodigitech.filehunt.R.string.app_name)+APP_NAME_POSTFIX);
