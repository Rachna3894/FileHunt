package com.mojodigitech.filehunt.junkCleanModule.util;
...
public class CleanUtil {
    ...
    public static void freeAllAppsCache(final Handler handler) {
        ...
        Context context = comScoreAnalytics.getInstance();
    ...
    public static void killAppProcesses(String packageName) {
        ...
        ActivityManager am = (ActivityManager) comScoreAnalytics.getInstance()
