package com.mojodigitech.filehunt.Adapter;
...
public class MultiSelectAdapter_Locker extends RecyclerView.Adapter<MultiSelectAdapter_Locker.MyViewHolder>  implements Filterable {
        ...
        public MyViewHolder(View view) {
           ...
           /*view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    int pos=getAdapterPosition();
                    if(pos!= RecyclerView.NO_POSITION)
                        listener.onUnhideSelectListener(LockerListfiltered.get(getAdapterPosition()));
                    return false;
                }
            });*/
    ...
    public interface fileSelectListener {
       ...
       // void onUnhideSelectListener(Model_Locker Locker_model);
    }
